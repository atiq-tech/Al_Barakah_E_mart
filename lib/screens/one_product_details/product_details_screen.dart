                    ...
                    Column(
                      ...
                      children: [
                        Text("Product Details : ",style: GoogleFonts.poppins(
                         ...
                         Divider(height: 1.h,indent: 1,thickness: 1,color: Colors.black,endIndent: 1),
                        SizedBox(height: 10.h),
                  ...
                  Container(
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                child: Text("Buy now",style: GoogleFonts.abyssinicaSil(fontSize: 16.sp,color: appBarColor)),
                              ),
                            ),
                          ),
                          SizedBox(width: 10.w),
                          Expanded(
                            ...
                            child: InkWell(
                              onTap: () {
                                ...
                                addToCart.addProduct(
                                  AddToCartModel(
                                    id: product.productSlNo is int? product.productSlNo : int.parse(product.productSlNo.toString()),
                                    productName: product.productName ?? "",
                                    image: "$imageUrl${product.mainImage}",
                                    quantity: count,
                                    slug: product.slug ?? "",
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Divider(height: 1.h,indent: 1,thickness: 1, color: Colors.black, endIndent: 1),
                        SizedBox(height: 10.h),
                        Container(child: Text(Bidi.stripHtmlIfNeeded(product.longDescription),textAlign: TextAlign.justify,style: GoogleFonts.tajawal(fontSize: 14.sp))),    
                      ],
                    ),
                    SizedBox(height: 10.h),
                    Column(
