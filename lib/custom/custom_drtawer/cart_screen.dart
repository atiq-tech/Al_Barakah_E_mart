...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget _totalRow(String title, String value, {bool isBold = false}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 2),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Text(title, style: TextStyle(fontWeight: isBold ? FontWeight.bold : FontWeight.w500, fontSize: 12.sp)),
          SizedBox(width: 10.w),
          Text("$value",
              style: TextStyle(
                  color: Colors.orange,
